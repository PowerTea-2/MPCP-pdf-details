...
/* Colour macros (stubs for headless build) */
#define C_PLUM   ""
#define C_VIOLET ""
#define C_GRAPE  ""
#define C_ORCHID ""
...
static void ui_colour_init(void) { g_ui_colour = false; }
static void ui_print_logo(void) {
    printf("\n  AethroSync — Multi-Port Catch Protocol  v0.5\n\n");
}
